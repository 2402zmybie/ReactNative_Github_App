...
import { Platform,DeviceInfo,View,Text,Image,Dimensions,StyleSheet} from 'react-native'
    ...
    getParallaxRenderConfig(params) {
        ...
        config.renderFixedHeader = () => (
            <View key="fixed-header" style={styles.fixedSection}>
                {ViewUtil.getLeftBackButton(() => NaivigationUtil.goBack(this.props.navigation))}
    ...
    render(contentView,params) {
        ...
        return (
            <ParallaxScrollView
                ...
                contentBackgroundColor={GlobalStyles.backgrounudColor}
